...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="registerform" id="registerform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'register' ); ?>" method="post">
		<p>
			<label for="user_login<?php $template->the_instance(); ?>"><?php _e( 'Patient ID' ); ?></label>
			<input type="text" pattern="[0-9]*" title="Only numbers are allowed" name="user_login" id="user_login<?php $template->the_instance(); ?>" class="input" value="<?php $template->the_posted_value( 'user_login' ); ?>" size="20" />
		</p>
