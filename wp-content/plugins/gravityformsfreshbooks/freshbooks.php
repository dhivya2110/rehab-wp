...
class GFFreshBooks {
    ...
    public static function settings_page(){
        ...
        else if($_POST["gf_freshbooks_submit"]){
                                ...
                                <tr class='author-self status-inherit' valign="top">
                                    ...
                                    <td class="column-title">
                                        ...
                                        <div class="row-actions">
                                            <span class="edit">
                                            <a title="Edit this setting" href="admin.php?page=gf_freshbooks&view=edit&id=<?php echo $setting["id"] ?>" title="<?php _e("Edit", "gravityformsfreshbooks") ?>"><?php _e("Edit", "gravityformsfreshbooks") ?></a>
                                            |
                                            </span>
    ...
    private static function edit_page(){
        ...
        if($_POST["gf_freshbooks_submit"]){
            ...
            */
            ...
            if($is_valid){
                ...
                $config["meta"]["is_fixed_cost"] = $_POST["gf_freshbooks_is_fixed"] == "1";
                $config["meta"]["update_client"] = $_POST["gf_freshbooks_update_client"] == "1";

                $config["meta"]["optin_enabled"] = $_POST["freshbooks_optin_enable"] ? true : false;
        ...
        <form method="post" action="">
            ...
            <div id="freshbooks_options_container" style="display: <?php echo $display ?>;">
                <div class="margin_vertical_10<?php echo $email_validation_class?>">
                    <label for="gf_freshbooks_email" class="left_header"><?php _e("Email", "gravityforms_feed"); ?> <span class='feeds_required'>*</span></label>
                    <?php echo self::get_field_drop_down("gf_freshbooks_email", $form_fields, $config["meta"]["email"]) ?>

                    <input type="checkbox" name="gf_freshbooks_update_client" id="gf_freshbooks_update_client" value="1" <?php echo $config["meta"]["update_client"] ? "checked='checked'" : "" ?> />
                ...
                <div class="margin_vertical_10<?php echo $fname_validation_class?>">
                    ...
                    <?php echo self::get_field_drop_down("gf_freshbooks_first_name", $form_fields, $config["meta"]["first_name"]) ?>
                </div>
                <div class="margin_vertical_10<?php echo $lname_validation_class?>">
                    ...
                    <?php echo self::get_field_drop_down("gf_freshbooks_last_name", $form_fields, $config["meta"]["last_name"]) ?>
                </div>
                <div class="margin_vertical_10<?php echo $organization_validation_class?>">
                    ...
                    <?php echo self::get_field_drop_down("gf_freshbooks_organization", $form_fields, $config["meta"]["organization"]) ?>
                </div>
                <div class="margin_vertical_10">
                    <label for="gf_freshbooks_address" class="left_header"><?php _e("Address", "gravityforms_feed"); ?></label>
                    <?php echo self::get_field_drop_down("gf_freshbooks_address", $form_fields, $config["meta"]["address"]) ?>
                </div>
                <div class="margin_vertical_10">
                    <label for="gf_freshbooks_phone" class="left_header"><?php _e("Phone", "gravityforms_feed"); ?></label>
                    <?php echo self::get_field_drop_down("gf_freshbooks_phone", $form_fields, $config["meta"]["phone"]) ?>
                </div>
                <div class="margin_vertical_10">
                    <label for="gf_freshbooks_fax" class="left_header"><?php _e("Fax", "gravityforms_feed"); ?></label>
                    <?php echo self::get_field_drop_down("gf_freshbooks_fax", $form_fields, $config["meta"]["fax"]) ?>
                </div>
                <div class="margin_vertical_10">
                    <label for="gf_freshbooks_notes" class="left_header"><?php _e("Notes", "gravityforms_feed"); ?></label>
                    <textarea class="freshbooks_notes" name="gf_freshbooks_notes" id="gf_freshbooks_notes"><?php echo $config["meta"]["notes"] ?></textarea>
                </div>
                <?php
                ...
                <div id="gf_freshbooks_invoice_container" <?php echo $also_create == "neither" ? "style='display:none;'" : "" ?>>
                    <div class="margin_vertical_10">
                        ...
                        <?php echo self::get_field_drop_down("gf_freshbooks_ponumber", $form_fields, $config["meta"]["ponumber"]) ?>
                    </div>
                    <div class="margin_vertical_10">
                        ...
                        <input type="text" size="10" name="gf_freshbooks_discount" id="gf_freshbooks_discount" value="<?php echo $config["meta"]["discount"] ?>"/> %
                    </div>
                    <?php
                    $is_fixed_cost = $config["meta"]["is_fixed_cost"] == "1" || $config["meta"]["is_fixed_cost"] === null;
                    ?>
                    <div class="margin_vertical_10">
                        ...
                        <div id="gf_freshbooks_lineitem_container">
                            ...
                            &nbsp;&nbsp;
                            <input type="radio" name="gf_freshbooks_is_fixed" id="gf_freshbooks_dynamic_cost" value="0" <?php echo !$is_fixed_cost ? "checked='checked'" : "" ?> onclick="ToggleFixedCost();"/>
                        ...
                        <table class='gf_freshbooks_lineitem_table'>
                            ...
                            if(!is_array($config["meta"]["items"]) || sizeof($config["meta"]["items"]) == 0)
                                $config["meta"]["items"] = array(array());

                            foreach($config["meta"]["items"] as $item){
                                $cost_fields = self::get_field_drop_down_items($form_fields, $is_fixed_cost ? "" : $item["cost"]);
                                $quantity_fields = self::get_field_drop_down_items($form_fields, $is_fixed_cost ? "" : $item["quantity"]);
                                $items = self::get_items($item["item_id"]);
                                echo self::line_item($items, $cost_fields, $quantity_fields, $item["description"], $is_fixed_cost ? $item["cost"] : "", $is_fixed_cost ? $item["quantity"] : "", $is_fixed_cost);
                            }
                    ...
                    <div class="margin_vertical_10">
                        ...
                        <textarea class="freshbooks_notes" name="gf_freshbooks_notes2" id="gf_freshbooks_notes2"><?php echo $config["meta"]["notes2"] ?></textarea>
                    </div>
                    <div class="margin_vertical_10">
                        <label for="gf_freshbooks_terms" class="left_header"><?php _e("Terms", "gravityforms_feed"); ?></label>
                        <textarea class="freshbooks_notes" name="gf_freshbooks_terms" id="gf_freshbooks_terms"><?php echo $config["meta"]["terms"] ?></textarea>
                    </div>
                </div>
                ...
                <div id="freshbooks_optin_container" valign="top" class="margin_vertical_10">
                    ...
                    <div id="freshbooks_optin">
                        <table>
                            <tr>
                                <td>
                                    <input type="checkbox" id="freshbooks_optin_enable" name="freshbooks_optin_enable" value="1" onclick="if(this.checked){jQuery('#freshbooks_optin_condition_field_container').show('slow');} else{jQuery('#freshbooks_optin_condition_field_container').hide('slow');}" <?php echo $config["meta"]["optin_enabled"] ? "checked='checked'" : ""?>/>
                                    <label for="freshbooks_optin_enable"><?php _e("Enable", "gravityforms_feed"); ?></label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="freshbooks_optin_condition_field_container" <?php echo !$config["meta"]["optin_enabled"] ? "style='display:none'" : ""?>>
                                        <div id="freshbooks_optin_condition_fields" <?php echo empty($selection_fields) ? "style='display:none'" : ""?>>
                                            <?php _e("Export to FreshBooks if ", "gravityforms_feed") ?>

                                            <select id="freshbooks_optin_field_id" name="freshbooks_optin_field_id" class='optin_select' onchange='jQuery("#freshbooks_optin_value").html(GetFieldValues(jQuery(this).val(), "", 25));'><?php echo $selection_fields ?></select>
                                            <select id="freshbooks_optin_operator" name="freshbooks_optin_operator" >
                                                <option value="is" <?php echo $config["meta"]["optin_operator"] == "is" ? "selected='selected'" : "" ?>><?php _e("is", "gravityforms_feed") ?></option>
                                                <option value="isnot" <?php echo $config["meta"]["optin_operator"] == "isnot" ? "selected='selected'" : "" ?>><?php _e("is not", "gravityforms_feed") ?></option>
                                            </select>
                                            <select id="freshbooks_optin_value" name="freshbooks_optin_value" class='optin_select'>
                                            </select>

                                        </div>
                                        <div id="freshbooks_optin_condition_message" <?php echo !empty($selection_fields) ? "style='display:none'" : ""?>>
                                            <?php _e("To create an export condition, your form must have a drop down, checkbox or multiple choice field.", "gravityformfreshbooks") ?>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="margin_vertical_10">
                    <input type="submit" class="button-primary" name="gf_freshbooks_submit" value="<?php echo empty($id) ? __("Save Feed", "gravityformsfreshbooks") : __("Update Feed", "gravityformsfreshbooks"); ?>" />
                </div>
            </div>
        </form>
        </div>
        <script type="text/javascript">
            ...
            function ToggleFixedCost(){
                var isFixed = jQuery("#gf_freshbooks_fixed_cost").is(":checked");
                if(isFixed){
            ...
            function SetOptin(selectedField, selectedValue){
                ...
                if(optinConditionField){
                    ...
                    jQuery("#freshbooks_optin_value").html(GetFieldValues(optinConditionField, selectedValue, 25));
                }
                else{
    ...
    private static function is_valid_credentials(){
        ...
        $dummy = array();
        return $items->listing($dummy, $dummy);
    }
