...
class GFCampaignMonitor {
    ...
    public static function settings_page(){
        ...
        else if($_POST["gf_campaignmonitor_submit"]){
                                ...
                                <tr valign="top">
                                    ...
                                    <td class="column-title">
                                        ...
                                        <div class="row-actions">
                                            <span class="edit">
                                            <a title="Edit this setting" href="admin.php?page=gf_campaignmonitor&view=edit&id=<?php echo $setting["id"] ?>" title="<?php _e("Edit", "gravityformscampaignmonitor") ?>"><?php _e("Edit", "gravityformscampaignmonitor") ?></a>
                                            |
                                            </span>
    ...
    private static function get_name($entry, $field_id){
        ...
        $prefix = trim($entry[$field_id . ".2"]);
        $first = trim($entry[$field_id . ".3"]);
        $last = trim($entry[$field_id . ".6"]);
        $suffix = trim($entry[$field_id . ".8"]);
